...
public interface UnAppliedCashRepository extends JpaRepository<UnAppliedCashEntity, Long> {
    ...
    UnAppliedCashEntity findByRefContractIdAndWriteOffTypeAndCreateDateAfter(Long refContractId, WriteOffTypeEnum writeOffType, Timestamp timestamp);

    List<UnAppliedCashEntity> findByRefContractIdInAndWriteOffTypeAndCreateDateAfter(List<Long> contractIds, WriteOffTypeEnum writeOffType, Timestamp timestamp);
