...
public class RelationToContractVO {
    ...
    public void check() throws BaseException {
        if (Strings.isNullOrEmpty(getContractId())
                ...
                || (EnumUtils.findByCode(WriteOffTypeEnum.values(), getType())) == null) {
    ...
    public WriteOffTypeEnum checkAndGetType() {
        return EnumUtils.findByCode(WriteOffTypeEnum.values(), getType());
    }
